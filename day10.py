...
for index, num in enumerate(lines[:-1]):
    if num + 1 == lines[index+1]:
        count_diff_1 += 1
    elif num + 2 == lines[index+1]:
        count_diff_2 += 1
    elif num + 3 == lines[index+1]:
        count_diff_3 += 1
    else:
...
while index < len(lines) - 1:
    if lines[index] + 3 == lines[index+1]:
        index_t = index
        segment = lines[index_f:index_t+1]
        # print(segment)
        if len(segment) == 5:
            list_diff.append(7)
        elif len(segment) == 4:
